...
while(peopleInLine < 0):
 peopleInLine = int(input("How many people are in line? "))
...
def calculateWaitTime(lineSpot):
  coasterRuns = numRuns(lineSpot, totalSeats)
...
if(answer == "yes" or answer == "YES" or answer == "Yes"):
 print("Your wait time is " + str(calculateWaitTime(placeInLine)) + " minutes")
